...
export default async function ComparisonArticlePage({ params }: PageProps) {
            ...
            <aside className="md:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-muted p-6 border border-border rounded-lg">
                  <h3 className="font-serif font-bold text-lg mb-4 text-foreground">Related Comparisons</h3>
                  <ul className="space-y-3 text-sm">
                    {getAllPosts("comparisons")
